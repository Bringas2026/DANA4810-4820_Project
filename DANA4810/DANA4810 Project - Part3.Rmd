...
- $R^2$ ($\approx 0.512$): Indicates that our linear model explains
...
- RMSE ($\approx 0.353$) & MAE ($\approx 0.275$): On average, the model's
...
- Stability of the estimate: the raw spread across individual fold scores
...
the four techniques we have implemented so far, Data Split, LOOCV, and
$k$-fold CV, and Repeated $k$-fold CV, using both the theory behind them and what we actually
...
- **LOOCV**, **$k$-fold CV**, and **Repeated $k$-fold CV** all use
  ...
  ($R^2 \approx 0.504$, $0.499$, and $0.512$ respectively). For a
