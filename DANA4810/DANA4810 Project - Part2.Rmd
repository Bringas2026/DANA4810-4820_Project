...
2. Find the commit you want to restore and copy its short hash / SHA (e.g., `3a6536d8`).<br>

```{r, echo=FALSE, out.width="80%", fig.align="left"}
knitr::include_graphics("44_Hash.png")
```
...
5. Push the commit so the rest of the team also sees the restored version — either run `git push`, or simply click the **"Push"** button in RStudio as in Section 3.6.<br>
...
**- Pulling the latest version from GitHub (safest):**
...
2. Click the **Issues** tab.<br>
3. Click **New Issue**, describe the task or problem, and click **Submit**.<br>

```{r, echo=FALSE, out.width="80%", fig.align="left"}
knitr::include_graphics("53_Issues.png")
```

**Pull Request comments:**<br>

When a teammate reviews your work before it gets merged into `main` (see Section 5.1), they leave their feedback directly on the Pull Request as comments. This keeps the whole discussion about a change attached to the exact lines being discussed, instead of getting scattered across email or chat.
```{r, echo=FALSE, out.width="80%", fig.align="left"}
knitr::include_graphics("54_PullRequest.png")
```
...
**Why branches matter for teams:**<br>
...
**How to create a branch in RStudio:**<br>

1. In the Git tab, click the **branch icon** (purple icon near the top right of the Git pane).<br>

```{r, echo=FALSE, out.width="80%", fig.align="left"}
knitr::include_graphics("47_Branch.png")
```

2. Type a descriptive name for your branch (e.g., `feature/add-section-5` or `fix/typo-introduction`).<br>
3. Click **Create**. RStudio will automatically switch you to that branch<br>
...
**What it means:** Someone else pushed changes to GitHub while you were working. Your local version is now behind the remote version.<br>
**How to fix it:** Pull first to download the new changes, then push again. If there are no conflicts, it will work automatically.
```
git pull origin main
```

<br>
<u>**Error 2: Merge Conflict**</u>
...
1. **Introduction to GitHub:** https://rainsworth.github.io/intro-to-github/06_Collaboration.html
2. **Earth Data Science:** Github Collaborative Workflow for Team Science https://earthdatascience.org/courses/intro-to-earth-data-science/git-github/github-collaboration/github-for-collaboration-open-science-workflow/
3. **GitProtect Blog:** Git Revert File to Previous Commit: How to Do It? https://gitprotect.io/blog/git-revert-file-to-previous-commit/
4. **Pro Git Book:** Git Tools - Reset Demystified https://git-scm.com/book/en/v2/Git-Tools-Reset-Demystified
5. **Atlassian Git Tutorials:** https://www.atlassian.com/git/tutorials/
6. **Dangit, Git!?!:** https://dangitgit.com/
7. **GitHub Docs:** Resolving a merge conflict using the command line https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/addressing-merge-conflicts/resolving-a-merge-conflict-using-the-command-line
